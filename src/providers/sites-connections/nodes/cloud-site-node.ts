...
import { EnapterCloudIcon, WarningIcon } from "../../../ui/icons";
...
export class CloudSiteNode extends vscode.TreeItem {
    ...
    getChildren(): vscode.TreeItem[] {
        return [
            ...
            new ApiTokenNode(this, this.site)
        ].filter((i) => !!i);
    }
    ...
    setIcon(isInvalid: boolean) {
        this.iconPath = isInvalid
            ? new WarningIcon()
            : new EnapterCloudIcon();
    }

    setContextValue() {
        this.contextValue = this.site.isActive
            ? "enapter.viewItems.ActiveSite"
            : "enapter.viewItems.Site";
    }
